...
sed -i "s/#\{0,1\}shared_preload_libraries.*/shared_preload_libraries = 'pg_hint_plan,pg_prewarm'/" $(pwd)/data/postgresql.conf
echo "pg_prewarm.autoprewarm = false" >>  $(pwd)/data/postgresql.conf
