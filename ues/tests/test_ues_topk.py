...
class BeningQueryOptimizationTests(unittest.TestCase):
    def test_base_query(self):
        ...
        optimized = ues.optimize_query(query, join_cardinality_estimation="topk", trace=True)
    ...
    def test_workload(self):
        for label, query in job_workload.items():
            try:
                ...
                ues.optimize_query(parsed, join_cardinality_estimation="topk")
...
class SnowflaxeQueryOptimizationTests(unittest.TestCase):
    def test_base_query(self):
        ...
        optimized = ues.optimize_query(query, join_cardinality_estimation="topk")
...
class CrossProductQueryOptimizationTests(unittest.TestCase):
    def test_base_query(self):
        ...
        ues.optimize_query(query, join_cardinality_estimation="topk")
...
class WeirdQueriesOptimizationTests(unittest.TestCase):
    def test_no_joins_query(self):
        ...
        query = mosp.MospQuery.parse(raw_query)
        optimized_query = ues.optimize_query(query, join_cardinality_estimation="topk")
